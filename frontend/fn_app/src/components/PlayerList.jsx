...
const PlayerList = () => {
  ...
  return (
    <div className="flex flex-col items-center ">
      <h1 className="py-10 md:p-10">Select a Player</h1>
      <div className=" grid grid-cols-5 grid-rows-1 py-6 border-b-2  w-[80vw]  md:w-150 lg:w-200  text-sm md:text-lg ">
        <p>Player Name</p>
        <p>Country</p>
        <p>PR Points</p>
        <p>Earnings</p>
      ...
      {players.map((player) => (
        <div
          ...
          className="grid grid-cols-5 grid-rows-1 border-b-2 border-[#202022] h-[10vh] md:h-[7vh] w-[80vw] md:w-150 lg:w-200 text-sm md:text-lg items-center justify-center"
        >
